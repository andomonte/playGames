          ...
          <Box display="flex" flexDirection="row" mt={2}>
            <Grid item xs={12} md={3}>
              <Box borderRadius={16} {...defaultProps}>
                <Box width="100%">
                  <h3>
                    <strong>{perguntas[2].Pergunta}</strong>{' '}
                  </h3>
                </Box>
              </Box>
            </Grid>
          ...
          <Box display="flex" flexDirection="row" mt={2}>
            <Grid item xs={12} md={3}>
              <Box bgcolor={colorA} borderRadius={16} {...defaultProps}>
                ...
                <Box>
                  <strong>{perguntas[2].LetraA}</strong>
                </Box>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} md={3}>
              <Box bgcolor={colorB} borderRadius={16} {...defaultProps}>
                ...
                <Box>
                  <strong>{perguntas[2].LetraB}</strong>
                </Box>
              </Box>
            </Grid>
          </Box>
          <Box display="flex" flexDirection="row" mt={2}>
            <Grid item xs={12} md={3}>
              <Box bgcolor={colorC} borderRadius={16} {...defaultProps}>
                ...
                <Box>
                  <strong>{perguntas[2].LetraC}</strong>
                </Box>
              </Box>
            </Grid>
            <Grid item xs={12} md={3}>
              <Box bgcolor={colorD} borderRadius={16} {...defaultProps}>
                ...
                <Box>
                  <strong>{perguntas[2].LetraD}</strong>
                </Box>
              </Box>
            </Grid>
          </Box>
